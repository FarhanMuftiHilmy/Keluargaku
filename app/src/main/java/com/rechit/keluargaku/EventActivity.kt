...
import com.rechit.keluargaku.adapters.AutoCompleteTextViewAdapter
import com.rechit.keluargaku.dialogs.*
...
class EventActivity : SimpleActivity() {
    ...
    private var mStoredEventTypes = ArrayList<Event.EventType>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ensureBackgroundThread {
            mStoredEventTypes = eventTypesDB.getEventTypes().toMutableList() as ArrayList<Event.EventType>
