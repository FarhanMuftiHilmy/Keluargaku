...
import com.rechit.keluargaku.BuildConfig
import com.rechit.keluargaku.R
import com.rechit.keluargaku.adapters.EventListAdapter
import com.rechit.keluargaku.databases.EventsDatabase
import com.rechit.keluargaku.dialogs.ExportEventsDialog
import com.rechit.keluargaku.dialogs.FilterEventTypesDialog
import com.rechit.keluargaku.dialogs.ImportEventsDialog
import com.rechit.keluargaku.dialogs.SetRemindersDialog
import com.rechit.keluargaku.extensions.*
import com.rechit.keluargaku.fragments.*
import com.rechit.keluargaku.helpers.*
import com.rechit.keluargaku.helpers.Formatter
import com.rechit.keluargaku.helpers.IcsExporter.ExportResult
import com.rechit.keluargaku.helpers.IcsImporter.ImportResult
...
class KalendarActivity : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun addHolidays() {
        ...
        RadioGroupDialog(this, items) {
            ...
            ensureBackgroundThread {
                ...
                if (eventTypeId == -1L) {
                    val eventType = Event.EventType(null, holidays, resources.getColor(R.color.default_holidays_color))
    ...
    private fun getBirthdaysEventTypeId(): Long {
        ...
        if (eventTypeId == -1L) {
            val eventType = Event.EventType(null, birthdays, resources.getColor(R.color.default_birthdays_color))
            eventTypeId = eventsHelper.insertOrUpdateEventTypeSync(eventType)
        }
        return eventTypeId
    }
    ...
    private fun getAnniversariesEventTypeId(): Long {
        ...
        if (eventTypeId == -1L) {
            val eventType = Event.EventType(null, anniversaries, resources.getColor(R.color.default_anniversaries_color))
            eventTypeId = eventsHelper.insertOrUpdateEventTypeSync(eventType)
        }
        return eventTypeId
    }
