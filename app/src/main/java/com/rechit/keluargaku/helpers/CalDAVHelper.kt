...
import com.rechit.keluargaku.objects.States.isUpdatingCalDAV
...
class CalDAVHelper(val context: Context) {
    ...
    fun updateCalDAVCalendar(eventType: Event.EventType) {
        val uri = Calendars.CONTENT_URI
    ...
    private fun fillCalendarContentValues(eventType: Event.EventType): ContentValues {
