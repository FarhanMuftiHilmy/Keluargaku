...
class EventsHelper(val context: Context) {
    ...
    fun getEventTypes(activity: Activity, showWritableOnly: Boolean, callback: (notes: ArrayList<Event.EventType>) -> Unit) {
        ensureBackgroundThread {
            var eventTypes = ArrayList<Event.EventType>()
            try {
                eventTypes = eventTypesDB.getEventTypes().toMutableList() as ArrayList<Event.EventType>
