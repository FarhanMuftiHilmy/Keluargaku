...
import com.rechit.keluargaku.extensions.eventsDB
...
import com.rechit.keluargaku.models.Reminder
...
class IcsImporter(val activity: SimpleActivity) {
    ...
    private fun tryAddCategories(categories: String) {
        ...
        curEventTypeId = if (eventId == -1L) {
            ...
            val eventType = Event.EventType(null, eventTypeTitle, newTypeColor)
